...
angle: The Sunday brunch edit — where to linger over coffee and a long table, verified per venue. Distinct from (and links to) the existing brunch piece by going broad/weekday. ⊛
...
angle: 24 hours in JB — eat, spa, shop, wander; a considered day trip. ⊛ (KD1, SERP beatable)
...
angle: The most beautiful afternoon-tea settings in Singapore right now — the hotel-luxury ritual, verified per venue. (high tea 5.8k/KD2)
...
angle: Penang, considered — eat, walk, stay; George Town heritage. ⊛ (KD2, SERP beatable)
...
angle: The scent-wardrobe guide — layering, oils and the houses worth knowing; fragrance as editorial, not transaction. (best perfume store 5.4k/KD0)
...
angle: The matcha rooms — Singapore's quiet social ritual; specialty matcha cafés. (KD0, SERP all DR<35)
...
angle: The SG modest-luxury labels to know — distinct from New Bahru's place-led angle (the labels, not the building).
...
angle: The dessert bars insiders know — a late-night dessert map for a considered evening. (KD0)
...
keyword: labuan bajo
angle: Labuan Bajo & Flores, considered — the CNA-validated Indonesia gap (9.2k head); where to eat, stay and swim.
...
angle: The halal omakase counters worth booking — tea-paired tasting menus. (best omakase 1.2k)
links: /dining/halal-fine-dining-singapore-2026/, cluster: afternoon-tea-singapore
source: keyword-research-2026-h2
...
angle: The best halal roast duck & modern Chinese in Singapore — the halal edit of a 2.3k list.
...
angle: The Arahkaii weekend edit — things to do, refreshed; clones HB SG's 5.8k-traffic format with a considered lens.
...
angle: The halal Michelin guide to Singapore — which starred rooms are verified and bookable.
...
angle: Dubai vs Singapore — two visions of modern-luxury living and dining; a comparison worth making. ⊛
...
angle: Tokyo, considered — halal kaiseki and the practical detail for a considered trip; private onsen etiquette. (low SG / global intent)
...
angle: The best halal chilli crab & seafood in Singapore — iconic dish, halal options. (red house 1.2k)
...
angle: Singapore skyline dining — the rooftop & view-table edit. ⊛
...
angle: The pastry/matcha/tea-masters quietly defining 2026 (verify named subjects).
...
angle: A quiet corner at home — a considered nook for stillness, scent and soft light; an original interiors angle.
...
keyword: oud perfume
angle: The attar revival — oud, attar and the Gulf-to-Asia scent language.
...
angle: The mooncake edit — the mooncakes & tea pairings worth gifting, verified per maker. (Mid-Autumn ~25 Sep)
links: cluster: afternoon-tea-singapore, /dining/halal-fine-dining-singapore-2026/
source: keyword-research-2026-h2
...
angle: Where to eat & recover over F1 weekend — the dining + day-spa recovery edit.
...
angle: The iftar tables worth booking — hotel iftar programmes, verified per venue. (Ramadan ~17 Feb–19 Mar)
links: /dining/halal-fine-dining-singapore-2026/, cluster: afternoon-tea-singapore
source: keyword-research-2026-h2

### 2027-02-22 | status:proposed | type:trending | pillar:beauty | format:explainer | words:1400 | score:74
keyword: ramadan skincare
angle: Skincare for fasting days — fasting-friendly hydration & barrier care. (Ramadan)
links: cluster: japanese-skincare-brands, cluster: retinal-vs-retinol
source: keyword-research-2026-h2
